...
- [ ] Backend images pushed to ACR (latest + v1.6.0)
- [ ] Frontend images pushed to ACR (latest + v1.6.0)
...
- [ ] Backend deployed with revision v1-6-0
- [ ] Frontend deployed with revision v1-6-0
...
### New Features
- [ ] Change Order edit functionality works properly
- [ ] Main layout positioning and resize behavior is correct
- [ ] Change Order pages display with branded layout
- [ ] Terms & Conditions Phase 2 features functional
